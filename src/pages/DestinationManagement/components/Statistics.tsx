      ...
      try {
        ...
        if (!schedulesData && !scheduleItemsData && !budgetItemsData && !destinationsData) {
          ...
          try {
            ...
            setScheduleItems(localStorage.getItem('scheduleItems') ? JSON.parse(localStorage.getItem('scheduleItems')!) : []);
            setBudgetItems(localStorage.getItem('budgetItems') ? JSON.parse(localStorage.getItem('budgetItems')!) : []);
            setDestinations(localStorage.getItem('destinations') ? JSON.parse(localStorage.getItem('destinations')!) : []);
          } catch (error) {
  ...
  return (
    <div style={{ padding: '24px', background: '#f0f2f5', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
        <div style={{ background: '#fff', padding: '16px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>
